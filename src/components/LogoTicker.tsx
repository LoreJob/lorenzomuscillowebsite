const LogoTicker = () => {
  ...
  const companies: { name: string; logoSrc?: string; size?: number }[] = [
    { name: "Samsung", logoSrc: "public/logos/Samsung_Orig_Wordmark_WHITE_RGB.png", size: 50 },
    { name: "ETH Zurich", logoSrc: "public/logos/eth_logo_kurz_neg.png", size: 60 },
    { name: "Tinexta", logoSrc: "public/logos/Tinexta_Neg_Whi_CMYK-1-Photoroom.png", size: 100 },
    { name: "Algoritmica.ai", logoSrc: "public/logos/b8cab-algoritmica_logo_retina_w.png", size: 30 },
    { name: "Wallmart", logoSrc: "public/logos/WMT-Wordmark-Small-TrueBlue-White-RGB.svg", size: 30 },
    { name: "Ca'Foscari", logoSrc: "public/logos/cafoscari.png", size: 100 },
  ];
